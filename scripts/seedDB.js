...
const bookSeed = [
  {
    ...
    image: "https://books.google.com/books/content?id=ZbUACwAAQBAJ&printsec=frontcover&img=1&zoom=1&edge=curl&source=gbs_api",
    url:"https://play.google.com/store/books/details?id=ZbUACwAAQBAJ",
  ...
  },
  {
    ...
    url: "https://market.android.com/details?id=book-iyfgqV5dxXQC",
    date: new Date(Date.now())
  }
  // ,
  // {
